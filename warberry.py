...
def external_IP_recon():
    try:
        site = urlopen("http://checkip.dyndns.org/", timeout=5)
        url = site.read()
...
def clear_output():
    ...
    if choice in yes:
        ...
        if os.listdir(work_path):
            ...
            if os.path.isdir("../old_responder_logs"):
